...
import com.pageFactory.Redeem_POF;
import com.pageFactory.login_POF;
import com.resources.base;

public class redeem_Testcase extends base {
	Redeem_POF Redeem_TC;
	...
	@Test
	public void f() {
		Redeem_TC = PageFactory.initElements(driver, Redeem_POF.class);
		Redeem_TC.RedeemAction();
	}
